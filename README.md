...
4. The bot requires permissions "Add Reactions", "Attach Files", "Send Messages", "View Channels", and "View Audit Log" If the default user permissions in your already allow this, this is not required
5. Save changes
